...
def daka2():
    ...
    c_time1=c_time.hour
    c_time2=c_time.minute
    c_time3=c_time.year
    c_time4=c_time.month
    c_time5=c_time.day
    if uname2==session.get('utname'):
        con2=1
        session['con2']=con2
        session['c_time1']=c_time1
        session['c_time2']=c_time2
        session['c_time3']=c_time3
        session['c_time4']=c_time4
        session['c_time5']=c_time5
...
def cin():
    ...
    c1=session.get('c_time1')
    c2=session.get('c_time2')
    c3=session.get('c_time3')
    c4=session.get('c_time4')
    c5=session.get('c_time5')
    if com2:
        return {'login_com2':com2,'login_c1':c1,'login_c2':c2,'login_c3':c3,'login_c4':c4,'login_c5':c5}
    return{}
...
def daka():
    ...
    cctime=ctime.hour
    cctime2=ctime.minute
    if uname==session.get('utname'):
        con=1
        session['con']=con
        session['cctime']=cctime
        session['cctime2']=cctime2
...
def cin():
    com=session.get('con')
    t=session.get('cctime')
    t2=session.get('cctime2')
    if com:
        return {'login_com':com,'login_t':t,'login_t2':t2}
    return{}
