...
data_path = "C:\workspace\\facefront\\face\dataset"  # 相关文件保存路径

KNOWN_FACE_ENCODINGS = "C:\workspace\\facefront\\face\dataset/known_face_encodings.npy"  # 已知人脸向量

KNOWN_FACE_NANE = "C:\workspace\\facefront\\face\dataset/known_face_name.npy"  # 已知人脸名称

known_face_names = []

known_face_encodings = []

name_and_encoding = "C:\workspace\\facefront\\face\dataset/face_encodings.txt"
